...
private let reuseIndentifier = "NotificationCell"
...
class NotificationsController: UITableViewController {
   ...
   //MARK: - Helpers
    ...
    func configureUI() {
        ...
        tableView.register(NotificationCell.self, forCellReuseIdentifier: reuseIndentifier)
...
extension NotificationsController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: reuseIndentifier, for: indexPath) as! NotificationCell
